...
class DialogflowConversation extends actionssdk_1.Conversation {
    ...
    constructor(options) {
        ...
        if (DialogflowConversation.isV1(this.body)) {
            ...
            const { action = '', parameters = {}, outputContexts, intent = {}, queryText = '', } = queryResult;
        ...
        const log = common_1.debug ? common_1.info : common_1.debug;
        log('Conversation', common_1.stringify(this, {
            request: null,
            headers: null,
            body: null,
        }));
